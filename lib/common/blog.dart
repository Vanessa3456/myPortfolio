...
class BlogPost extends StatefulWidget {
  ...
  final body;
  final isWeb;
  const BlogPost({required this.title, required this.body,required this.isWeb,super.key});
...
class _BlogPostState extends State<BlogPost> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: widget.isWeb?EdgeInsets.only(left: 70.0, right: 70.0, top: 40.0): EdgeInsets.only(left: 20.0, right: 20.0, top: 30.0),
      child: Container(
